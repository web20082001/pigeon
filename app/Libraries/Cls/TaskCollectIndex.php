...
class TaskCollectIndex extends BaseClass
{
    protected $search = 'task_id';
    protected $keywords = null;
    protected $order_by = 'collect_date';
    protected $dir = 'asc';
    protected $page_size;
    //类
    protected $mTaskCollect;

    //数据
    protected $taskCollects;
    ...
    function search($request = null)
    {
        ...
        return $this->taskCollects;
    }

    /**
     * @return mixed
     */
    public function getTaskCollects()
    {
        return $this->taskCollects;
    }
